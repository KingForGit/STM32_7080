...
//   <o> OS_PRIVCNT 使用系统固定栈大小的任务数 <0-250>
...
//   <o> OS_PRIVCNT = 0时，表示空闲任务栈大小 单位(*4)byte
...
// <h> 系统定时器设置
// =============================
//   <o>系统定时器选择(0:systick; 1:外设定时器 ) <0=> Core SysTick <1=> Peripheral Timer
...
//   <o> 时间片大小 OS_TICK *OS_ROBINTOUT(us)[ticks] <1-1000>
